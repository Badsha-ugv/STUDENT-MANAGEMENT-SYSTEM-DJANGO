...
from .models import CustomUser,Course,SessionYear,Student,Staff,Subject,Notification,StaffLeave,Feedback,StudentNotification,StudentFeedback,StudentLeave,TakeAttendance,AttendanceReport
